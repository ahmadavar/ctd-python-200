...
rate_a = 0.0    # Standard_B1s hourly rate (Scenario A) — fill in from Pricing Calculator
rate_b = 0.0    # Standard_NC6s_v3 hourly rate (Scenario B, VM only) — fill in from Pricing Calculator
